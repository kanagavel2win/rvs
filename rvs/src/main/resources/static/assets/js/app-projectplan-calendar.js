...
document.addEventListener('DOMContentLoaded', function () {
  (function () {
    const calendarEl = document.getElementById('calendar'),
      ...
      eventProjectName = document.querySelector('#eventTitle_Project_name'),
      eventTitle_Project_id = document.querySelector('#eventTitle_Project_id'),      
    ...
    //   window.open('projectview?id='+eventToUpdate.extendedProps.projectID, '_blank');
      ...
      if (offcanvasTitle) {
        offcanvasTitle.innerHTML = 'Update Project Task';
      }
      btnSubmit.innerHTML = 'Update';
      btnSubmit.classList.add('btn-update-event');
      btnSubmit.classList.remove('btn-add-event');
      btnDeleteEvent.classList.remove('d-none');
	  eventProjectName.value=eventToUpdate.extendedProps.projectName;
      eventTitle.value = eventToUpdate.extendedProps.activityTitle;
      eventTitle_Project_id.value= eventToUpdate.extendedProps.projectID;
    ...
    let calendar = new Calendar(calendarEl, {
      ...
      dateClick: function (info) {
        ...
        if (offcanvasTitle) {
          offcanvasTitle.innerHTML = 'Add Project Task';
        }
