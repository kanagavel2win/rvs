...
public class MemberAsperInternational implements Comparable<MemberAsperInternational> {
	...
	public String toString() {
		return "MemberAsperInternational [id=" + id + ", Multiple_District_Name=" + Multiple_District_Name
				+ ", District_Name=" + District_Name + ", Region_Name=" + Region_Name + ", Zone_Name=" + Zone_Name
				+ ", Title=" + Title + ", Club_ID=" + Club_ID + ", Club_Name=" + Club_Name + ", MemberID=" + MemberID
				+ ", Prefix=" + Prefix + ", First_Name=" + First_Name + ", Middle_Name=" + Middle_Name + ", Last_Name="
				+ Last_Name + ", Suffix=" + Suffix + ", Invalid_Member_Address_Flag=" + Invalid_Member_Address_Flag
